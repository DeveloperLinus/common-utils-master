...
import com.linus.common.databinding.ActGaoFenYunLiUiBinding
...
class GaoFenYunLiUIAct : BaseBindingActivity<ActGaoFenYunLiUiBinding>() {
    ...
    override fun init() {
        ...
        when(page) {
            ...
            "appointment_many_dt_pt_result" -> binding.ivGaoFengYunLi.background = resources.getDrawable(R.mipmap.view_appointment_many_dt_pt_result)
